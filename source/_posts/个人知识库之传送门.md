...
- [卡林巴琴在线练习](https://lizec.top/notebook/卡林巴琴在线练习.html)
- [事项快速核查清单](https://lizec.top/notebook/事项快速核查清单.html)
- [古文记忆助手](https://lizec.top/notebook/古文记忆助手.html)

### 开发工具

- [WindTerm - SSH客户端](https://github.com/kingToolbox/WindTerm)
- [WizTree - 磁盘空间分析工具](https://diskanalyzer.com/)


### 多媒体

- [VLC视频播放器](https://www.videolan.org/)

### 格式转换

- [iLovePDF | 为PDF爱好者提供的PDF文件在线处理工具](https://www.ilovepdf.com/zh-cn)
- [浏览器内执行的PDF相关工具](https://pdf.pi7.org/)
...
- [毫秒镜像(Docker镜像查询与下载)](https://1ms.run/)
- [轩辕镜像(Docker镜像查询)](https://xuanyuan.cloud/)
...
- [emoji图标语义查询](https://emojipedia.org/zh)
...
- [埃及圣书体文字查询](https://www.lexilogos.com/clavier/hieroglyphe.htm)
- [说文解字在线版](https://www.shuowen.cn/)

> 如果购买一本实体版的<<说文解字>>, 你就会发现还是能直接搜索的电子版好用

### 信息查询

- [实时台风消息](https://typhoon.slt.zj.gov.cn/#/)
...
- [AI Agent 根因模型与认知架构约束层设计](https://github.com/zxq321zxq/ai-agent-building-blocks-/blob/main/1.AI%20Agent%20%E6%A0%B9%E5%9B%A0%E6%A8%A1%E5%9E%8B%E4%B8%8E%E8%AE%A4%E7%9F%A5%E6%9E%B6%E6%9E%84%E7%BA%A6%E6%9D%9F%E5%B1%82%E8%AE%BE%E8%AE%A1.md) 这篇文章从LLM的原理出发, 讨论了AI Agent存在的一些问题(例如走捷径, 粉红大象等), 并给出相应的解决方案. 思路值得借鉴.

### 项目推荐

- [SillyTavern(酒馆)](https://sillytavern.wiki/installation/linuxmacos/)
- [chub.ai(酒馆角色卡平台)](https://chub.ai/)

> 酒馆的产生并不奇怪, 但酒馆角色卡的设计算是非常有趣. 通过在PNG图片中嵌入JSON文本, 实现了以图片的方式传输人物设定. 这一设计非常具有AI时代的感觉.
...
- [如何选择深度强化学习算法](https://zhuanlan.zhihu.com/p/342919579)
- [深度强化学习调参技巧](https://zhuanlan.zhihu.com/p/345353294)

> 5年前在调参, 5年后还在调参, 这也许并不本质, 只不过是在巨量参数里面获取的一点经验公式, 既不揭示本质, 又无指导意义. 但是做科研又有多少是本质的呢.
...
- [清华大学产业发展与环境治理研究中心 - CIDEG文库](https://www.cideg.tsinghua.edu.cn/column/wk). 收录了包括<<繁荣与停滞>>在内的许多高质量社会科学类书籍


国家政策类信源
-------------

即便是新华社这样的权威信源, 在新媒体渠道也时不时搞点弱智新闻. 因此还是从传统网站更能获得第一手信息, 也能少看点弱智新闻
...
- [在线黑白棋](https://tictactoefree.com/zh/reversi/)


### 资源汇总

- [https://www.kdocs.cn/l/cqO7lRHNtSFt](https://www.kdocs.cn/l/cqO7lRHNtSFt)
- [ipa游戏下载](https://decrypt.day/)
...
- [GitHub - ValKmjolnir/brainfuck-jit: Brainfuck Just-In-Time compiler written in C++ · GitHub](https://github.com/ValKmjolnir/brainfuck-jit)
- [GitHub - cosmos72/gomacro: Interactive Go interpreter and debugger with REPL, Eval, generics and Lisp-like macros · GitHub](https://github.com/cosmos72/gomacro)